...
<head>
    <meta charset="utf-8">
    <title>HomeService | Online Home Service</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+911234567890"><i class="fa fa-phone"></i> +88011111111</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    mahbuburrahman2310@gmail.com</a></li>
                        </ul>
                            ...
                            @if(Auth::user()->utype==='ADM')
                                <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li class="menu-item"><a title="Manage Slider" href="{{route('admin.slider')}}">Manage Slider</a></li>
            ...
            <div class="container">
                <div class="row visible-md visible-lg">
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">TV</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Geyser</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Refrigerator</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Washing Machine</a>
                            </li>
                            <li><i class="fa fa-check"></i> <a href="servicesbycategory/22.html">Microwave Oven</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Water Purifier</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        <h3>AC SERVICES </h3>
                        <ul>
                            <li><i class="fa fa-check"></i> <a
                                    href="{{route('home.services_categories')}}">Installation</a></li>
                            <li><i class="fa fa-check"></i> <a
                                    href="{{route('home.services_categories')}}">Uninstallation</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">AC Repair</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Gas Refill</a>
                            </li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Wet
                                    Servicing</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Dry
                                    Servicing </a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        <h3>HOME NEEDS </h3>
                        <ul>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Laundry </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Electrical</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Pest Control </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Carpentry </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Plumbing </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{route('home.services_categories')}}">Painting </a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        <h3>CONTACT US</h3>
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Mirpur, Dhaka</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">mahbuburrahman2310@gmail.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+911234567890">+111111111</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+911234567890">+111111111</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">© 2021 HomeService. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>            
